    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-bloom-ivory px-4">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-b-4 border-bloom-green-600 mx-auto mb-4"></div>
    ...
    <>
          ...
          <div className="space-y-4">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-bloom-green-500 focus:border-transparent transition-all duration-300 text-sm sm:text-base"
              />
            </div>
              ...
              <div className="hidden sm:flex items-center gap-3 lg:gap-4 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-bloom-green-500 focus:border-transparent text-sm lg:text-base"
                  >
              ...
              <div className="flex items-center bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className={`p-1.5 sm:p-2 rounded-md transition-all duration-300 ${
                    viewMode === 'grid' ? 'bg-white shadow-md text-bloom-green-600' : 'text-gray-600'
                  }`}
                >
                ...
                <button
                  ...
                  className={`p-1.5 sm:p-2 rounded-md transition-all duration-300 ${
                    viewMode === 'list' ? 'bg-white shadow-md text-bloom-green-600' : 'text-gray-600'
                  }`}
                >
            ...
            {showMobileFilters && (
              <div className="sm:hidden bg-gray-50 p-4 rounded-lg border">
                ...
                <select
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-bloom-green-500 focus:border-transparent text-sm"
                >
                  <option value="name">Sort by Name</option>
                  <option value="items-high">Most Items</option>
                  <option value="items-low">Least Items</option>
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold bg-bloom-green-600 bg-clip-text text-transparent mb-1 sm:mb-2">
                  {stat.number}
                </div>
                ...
                >
                  {viewMode === 'grid' ? (
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-200/50 relative">
                      {/* Order Process Badge */}
                      <div className="absolute top-2 sm:top-4 right-2 sm:right-4 bg-bloom-rose-600 text-white px-2 sm:px-3 py-1 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
                        📦 Add to Order
                      </div>
                      ...
                      <div className="p-3 sm:p-4 lg:p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center text-bloom-green-600 font-medium text-xs sm:text-sm group-hover:text-bloom-rose-600 transition-colors duration-300">
                    ...
                    <div className="bg-white rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200/50 p-4 sm:p-6">
                      <div className="flex items-center space-x-3 sm:space-x-4 lg:space-x-6">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-1 sm:mb-2 group-hover:text-bloom-green-600 transition-colors duration-300 line-clamp-1">
                            {category.name}
                          </h3>
                          ...
                          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500">
                            ...
                            <div className="flex items-center bg-bloom-rose-100 text-bloom-rose-700 px-2 py-1 rounded-full">
                        ...
                        <div className="flex-shrink-0">
                          <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 group-hover:text-bloom-green-600 group-hover:translate-x-1 transition-all duration-300" />
                        </div>
                      </div>
                    </div>
                  )}
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            >
              <div className="mb-6 sm:mb-8">
                <Award className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-bloom-green-600 mb-3 sm:mb-4" />
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-gray-500 px-4">
                {userData.location && (
                  <div className="flex items-center bg-white/80 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full shadow-md">
                    <MapPin className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-bloom-green-600" />
      ...
      <div className="py-12 sm:py-16 bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-4 sm:bottom-10 right-4 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-bloom-rose-600/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 sm:mb-6">
            Ready to Start Your
            <span className="bg-bloom-green-400 bg-clip-text text-transparent block mt-1 sm:mt-2">Order Process?</span>
          </h2>
