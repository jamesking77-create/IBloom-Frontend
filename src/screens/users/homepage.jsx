...
const HeroSlide = memo(({ slide, isActive, style }) => {
  ...
  return (
    <div className={`absolute inset-0 w-full h-full transition-opacity duration-700 ${isActive ? 'opacity-100 z-10' : 'opacity-0 z-0'}`} style={style}>
      {!imageLoaded && (
...
const FloatingItem = memo(({ item, index, style }) => (
  <div className={`absolute floating-item ${index % 2 === 0 ? "animate-float" : "animate-float-reverse"}`} style={style}>
...
const HomePage = () => {
  ...
  const rentalItems = useMemo(() => [
    ...
    },
    {
      id: 2,
      name: "Wedding Tent",
      image: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=300&h=300&fit=crop",
      category: "Tents",
    },
    {
      id: 3,
  ...
  const floatingItemsStyle = useMemo(() => {
    ...
    return rentalItems.map((_, index) => ({
      ...
      transform: `translate3d(0, ${offset * (index % 2 === 0 ? 1 : -1) * 0.5}px, 0)`,
  ...
  return (
    <>
      ...
      <div className="hero-section relative h-screen overflow-hidden">
        ...
        {/* Hero Content */}
        <div className={`absolute inset-0 flex items-center justify-center text-center text-white z-20 transition-opacity duration-300 ${heroReady ? 'opacity-100' : 'opacity-0'}`}>
        ...
        {/* Hero Pagination */}
        <div className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3 transition-opacity duration-300 ${heroReady ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="section-content relative py-32 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <div
            ...
            className={`transition-all duration-800 ${isVisible["floating-section"] ? "animate-fade-in-up" : "opacity-0"}`}
          >
      ...
      {/* Stats Section */}
      <div data-animate="stats" className="section-content py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div
            ...
            className={`text-center mb-16 transition-all duration-800 ${
              isVisible["categories-header"] ? "animate-fade-in-up" : "opacity-0"
            }`}
          >
              ...
              {rentalCategories.map((category, index) => (
                <div
                  ...
                  className={`group cursor-pointer transform transition-all duration-600 hover:scale-105 ${
                    isVisible[`category-${index}`] ? "animate-fade-in-up" : "opacity-0"
                  }`}
                ...
                >
                  <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-200/50 relative">
                    ...
                    <div className="relative overflow-hidden">
                      <img
                        src={category.image || `https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&h=300&fit=crop`}
                        alt={category.name}
                    ...
                    <div className="p-6">
                      ...
                      {category.itemCount === 0 && (
                        <p className="text-sm text-gray-400">Items coming soon</p>
                      )}
                    </div>
                  </div>
                </div>
