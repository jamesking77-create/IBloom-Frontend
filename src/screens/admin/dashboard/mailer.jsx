      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none inline-flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-slate-600 to-slate-700 text-white text-sm font-semibold rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
                    >
              ...
              <div className="flex-1 overflow-hidden">
                {loading ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="mt-2 text-slate-600 font-medium">Loading emails...</p>
                  </div>
                ) : filteredMails.length === 0 ? (
                  <div className="p-8 text-center">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Mail History */}
            {showHistory && (
              <div className="mt-6 bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                <div className="p-4 sm:p-6 border-b border-slate-200/60">
                  <h3 className="text-lg font-bold text-slate-800">
                    Recent Emails
                  </h3>
                ...
                <div className="max-h-80 sm:max-h-96 overflow-y-auto">
                  {mailHistory.length === 0 ? (
                    <div className="p-6 text-center">
                      ...
                      <p className="text-slate-600 font-medium">No email history</p>
                    </div>
                  ) : (
                    <div className="divide-y divide-slate-100">
                      {mailHistory.slice(0, 10).map((mail) => (
                        <div key={mail.id} className="p-4 hover:bg-slate-50/50 transition-colors">
