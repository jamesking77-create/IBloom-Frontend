...
const DashboardHeader = ({ toggleSidebar, isSidebarOpen, isMobile }) => {
  ...
  const { clearAllNotifications: clearGlobalNotifications } =
    ...
    if (bookings && bookings.length > 0) {
      ...
      recentBookings.forEach((booking, index) => {
        ...
        const eventType =
          ...
          "Event";
        const amount =
          booking.pricing?.formatted?.total || booking.amount || "₦0";
  ...
  const totalUnreadCount =
    unreadNotificationCount + allNotifications.filter((n) => n.isUnread).length;
      ...
      <div className="px-3 sm:px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div className="h-10 sm:h-12 w-auto">
            <img src={logoimg} alt="Dashboard Logo" className="h-full w-auto" />
          </div>
                    ...
                    {allNotifications.length === 0 ? (
                      <div className="py-8 px-4 text-center">
                        ...
                        <p className="text-xs text-gray-400">
                          You'll see booking updates and system alerts here
                        </p>
                      </div>
                    ) : (
