...
return (
  <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
    ...
    >
      ...
      <div className="overflow-y-auto flex-1" style={{ paddingBottom: '120px' }}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              disabled={item.outOfStock || (item.colors && item.colors.length > 0 && !selectedColor)}
              className={`w-full sm:flex-1 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition-all duration-300 transform active:scale-95 sm:hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center ${
                showAddedAnimation
                  ...
                  : item.outOfStock || (item.colors && item.colors.length > 0 && !selectedColor)
