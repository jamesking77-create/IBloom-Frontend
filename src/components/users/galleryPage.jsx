...
import { Facebook, Instagram, Twitter, Camera, Play, Eye, Heart, Share2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <div className={`text-white transform transition-all duration-1000 ${
            ...
            <p className="text-xl md:text-2xl leading-relaxed">
              Explore our stunning collection of memorable events and celebrations
            </p>
          </div>
        </div>
      ...
      <section className="py-12 bg-white sticky top-0 z-40 shadow-sm">
        <div className="max-w-6xl mx-auto px-4">
          <div className={`flex flex-wrap justify-center gap-4 transform transition-all duration-1000 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
              ...
              >
                <div className="aspect-video relative">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <span className="text-sm text-gray-200">{video.duration}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className={`transform transition-all duration-1000 ${
            ...
            <p className="text-xl text-white/90 mb-8">
              Let us help you bring your vision to life with our premium rental services.
            </p>
            <button className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
