...
import { Award, Users, Calendar, Star, ArrowRight, CheckCircle } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className={`text-center text-white transform transition-all duration-1000 ${
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
              {userData?.bio || 'Your premier destination for exceptional event rentals, creating unforgettable experiences for every occasion.'}
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`transform transition-all duration-1000 ${
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Founded with a passion for creating extraordinary events, {userData?.name || 'IBLOOM'} has been 
                at the forefront of the event rental industry. We understand that every celebration is unique, 
                and we're committed to providing the perfect elements to bring your vision to life.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                From intimate gatherings to grand celebrations, our extensive collection of premium rental 
                items and dedicated team ensures your event is nothing short of spectacular.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className={`text-center mb-12 transform transition-all duration-1000 ${
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              We offer a comprehensive range of services to make your event planning seamless and stress-free.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(userData?.specialize && userData.specialize.length > 0 ? userData.specialize : [
              'Wedding Rentals',
              'Corporate Events',
              'Birthday Parties',
              ...
              >
                ...
                <p className="text-gray-600">
                  Professional {service.toLowerCase()} with premium quality equipment and exceptional service.
                </p>
              </div>
            ))}
          </div>
